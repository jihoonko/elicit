...
if __name__ == '__main__':
    ...
    parser.add_argument("--lamb1", default=0.000103446, type=float, help="lamb1 found by search.py")
    parser.add_argument("--lamb2", default=0.948822292, type=float, help="lamb2 found by search.py")
    parser.add_argument("--lamb3", default=7127.2645, type=float, help="lamb3 found by search.py")
    parser.add_argument("--lr1", default=0.00011556, type=float, help="lr1 found by search.py")
    parser.add_argument("--lr2", default=0.000838633, type=float, help="lr2 found by search.py")
    parser.add_argument("--gpu", default=0, type=int, help="GPU id for running evaluation")
    ...
    algo = CompletionModel(dataset_name=args.dataset_name, is_test=1, budget=args.budget, lr_and_regs = (args.lamb1, args.lamb2, args.lamb3, args.lr1, args.lr2), device=args.gpu)
    result = algo.run()
    print('result:', result)